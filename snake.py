...
mySnakeColor = pygame.Color(163,234,233)
...
def init_vars():
    global head_pos, snake_body, food_pos, food_spawn, score, direction, highScore
...
while True:
    ...
    if(highScore < score):
        highScore = score
    with open("high score list.txt", "w") as l:
        l.write(str(highScore))
    ...
    for pos in snake_body:
        pygame.draw.rect(game_window, mySnakeColor, pygame.Rect(pos[0] + 2, pos[1] + 2, square_size - 2, square_size))
